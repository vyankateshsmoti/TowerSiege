...
function setup(){
   ...
   stand1 = new Ground(420,350,300,10);
   stand2 = new Ground(870,218,220,10);
   ...
   block8 = new CBlock1(340,262,40,50);
   block9 = new CBlock1(380,262,40,50);
   block10 = new CBlock1(420,262,40,50);
   block11 = new CBlock1(460,262,40,50);
   block12= new CBlock1(500,262,40,50);

   block13 = new CBlock2(380,212,40,50);
   block14 = new CBlock2(420,212,40,50);
   block15 = new CBlock2(460,212,40,50);

   block16 = new block(420,162,40,50);

   block17 = new CBlock1(790,185,40,50);
   block18 = new CBlock1(830,185,40,50);
   block19 = new CBlock1(870,185,40,50);
   block20 = new CBlock1(910,185,40,50);
   block21 = new CBlock1(950,185,40,50);

   block22 = new block(830,145,40,50);
   block23 = new block(870,145,40,50);
   block24 = new block(910,145,40,50);

   block25 = new CBlock2(870,105,40,50);

   polygon_Obj = new polygon(200,200,60,60);
   
slingshot = new SlingShot(polygon_Obj.body,{x:100,y:160});
